...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l|l|p{7cm}|}
			...
			Võ Anh Khoa            & Quản lý Giảng viên      & SP\_CAPNHAT\_CHUCVU\_GV, FN\_DEM\_GV\_THEO\_CHUCVU, TR\_NGAN\_CHAN\_XOA\_CHUCVU, SP\_THANG\_CHUC\_TRUONG\_KHOA    \\ \hline
			Nguyễn Gia Bảo         & Quản lý Khoa            & sp\_ThemKhoa, fn\_DemKhoaCoSoDienThoai, trg\_KiemTraSoDienThoai, sp\_DuyetTungHeDaoTao                            \\ \hline
			Nguyễn Viết An Bình    & Đăng ký và Quản lý điểm & sp\_DangKyHocPhan, trg\_TinhDiemTongKet, fn\_TinhDiemTrungBinh, Transaction đăng ký                               \\ \hline
			Mã Nhật Phong          & Quản lý Sinh viên       & sp\_LayDanhSachSV\_TheoLop, fn\_DemSoSinhVien\_TheoLop, trg\_NganXoaLop\_KhiConSinhVien, sp\_ChuyenLopChoSinhVien \\ \hline
			Nguyễn Hữu Hoàng Thông & Quản lý Môn học         & sp\_ThemMonHoc, sp\_XoaMonHoc, fn\_LayDanhSachMonTienQuyet, sp\_BaoCaoHocKy, fn\_KiemTraTienQuyet                 \\ \hline
		\end{tabular}
	}
\end{table}


\subsection{Chức năng 1: Quản lý Giảng viên (Võ Anh Khoa)}
...
% [CẦN THÊM HÌNH: Giao diện màn hình Quản lý giảng viên]
\begin{figure}[H]
	\centering
	\fbox{\parbox{0.8\textwidth}{\centering\textit{[Hình 4.2: Giao diện màn hình Quản lý giảng viên]}}}
...
% [CẦN THÊM HÌNH: Form cập nhật chức vụ giảng viên]
\begin{figure}[H]
	\centering
	\fbox{\parbox{0.8\textwidth}{\centering\textit{[Hình 4.3: Form cập nhật chức vụ giảng viên]}}}
	\caption{Form cập nhật chức vụ}
	\label{fig:form_cap_nhat_chuc_vu}
\end{figure}

\subsection{Chức năng 2: Quản lý Khoa (Nguyễn Gia Bảo)}
...
% [CẦN THÊM HÌNH: Giao diện quản lý khoa]
\begin{figure}[H]
	\centering
	\fbox{\parbox{0.8\textwidth}{\centering\textit{[Hình 4.4: Giao diện quản lý khoa]}}}
...
\subsection{Chức năng 3: Đăng ký và Quản lý điểm (Nguyễn Viết An Bình)}
...
% [CẦN THÊM HÌNH: Giao diện nhập điểm]
\begin{figure}[H]
	\centering
	\fbox{\parbox{0.8\textwidth}{\centering\textit{[Hình 4.6: Giao diện nhập điểm cho sinh viên]}}}
...
% [CẦN THÊM HÌNH: Bảng điểm sinh viên]
\begin{figure}[H]
	\centering
	\fbox{\parbox{0.8\textwidth}{\centering\textit{[Hình 4.7: Bảng điểm chi tiết của sinh viên]}}}
	\caption{Bảng điểm sinh viên}
	\label{fig:bang_diem}
\end{figure}

\subsection{Chức năng 4: Quản lý Sinh viên (Mã Nhật Phong)}
...
% [CẦN THÊM HÌNH: Giao diện quản lý sinh viên]
\begin{figure}[H]
	\centering
	\fbox{\parbox{0.8\textwidth}{\centering\textit{[Hình 4.8: Giao diện quản lý sinh viên]}}}
...
% [CẦN THÊM HÌNH: Danh sách sinh viên theo lớp]
\begin{figure}[H]
	\centering
	\fbox{\parbox{0.8\textwidth}{\centering\textit{[Hình 4.9: Danh sách sinh viên theo lớp]}}}
	\caption{Kết quả danh sách sinh viên}
	\label{fig:danh_sach_sv_lop}
\end{figure}

\subsection{Chức năng 5: Quản lý Môn học (Nguyễn Hữu Hoàng Thông)}
...
% [CẦN THÊM HÌNH: Giao diện quản lý môn học]
\begin{figure}[H]
	\centering
	\fbox{\parbox{0.8\textwidth}{\centering\textit{[Hình 4.10: Giao diện quản lý môn học]}}}
...
\begin{figure}[H]
	\centering
	\fbox{\parbox{0.8\textwidth}{\centering\textit{[Hình 4.11: Báo cáo sĩ số học kỳ]}}}
	\caption{Báo cáo học kỳ}
	\label{fig:bao_cao_hoc_ky}
\end{figure}

\subsection{Testing và Demo}
...
% [CẦN THÊM HÌNH: Kết quả test các chức năng]
\begin{figure}[H]
	\centering
	\fbox{\parbox{0.8\textwidth}{\centering\textit{[Hình 4.12: Kết quả kiểm thử các chức năng]}}}
...
\textbf{Video demo:}
\begin{itemize}
	\item Link video demo chức năng 1: [URL]
	\item Link video demo chức năng 2: [URL]
	\item Link video demo chức năng 3: [URL]
\end{itemize}
