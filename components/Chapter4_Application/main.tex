...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l|l|p{7cm}|}
			...
			Nguyễn Hữu Hoàng Thông & Quản lý Môn học         & sp\_ThemMonHoc, sp\_XoaMonHoc, sp\_CapNhatMonHoc, fn\_LayDanhSachMonTienQuyet, trg\_NganXoaHocKy, sp\_BaoCaoHocKy, fn\_KiemTraTienQuyet, sp\_DangKyMonHoc, trg\_KiemTraNgayDangKy \\ \hline
		\end{tabular}
	}
\end{table}
